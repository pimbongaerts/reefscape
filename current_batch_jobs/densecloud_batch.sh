...
~/tools/metashape-deepsquid-1.8/metashape.sh  -platform offscreen -r ~/reefscape/scripts/create_dense_cloud.py
...
~/tools/metashape-deepsquid-1.8/metashape.sh  -platform offscreen -r ~/reefscape/scripts/create_dense_cloud.py
cd /mnt/coral3d/focal_plots/cur_sna/cur_sna_10m/cur_sna_10m_20221205
~/tools/metashape-deepsquid-1.8/metashape.sh  -platform offscreen -r ~/reefscape/scripts/create_dense_cloud.py
